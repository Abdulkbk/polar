...
export const lnd = (
  ...
  // Mount btcd RPC cert dir for LND.
  if (isBtcdBackend && btcdBackendName) {
    volumes.push(
      `./volumes/${dockerConfigs.btcd.volumeDirName}/${btcdBackendName}/btcd:/home/lnd/.btcd`,
    );
  }
  return {
    image,
...
export const litd = (
  ...
  if (isBtcdBackend && btcdBackendName) {
    volumes.push(
      `./volumes/${dockerConfigs.btcd.volumeDirName}/${btcdBackendName}/btcd:/home/litd/.btcd`,
    );
  }
  return {
    image,
